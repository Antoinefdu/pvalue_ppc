...
This project was inspired by something I made on Excel a while ago as a PPC Manager. It automatically calculates the P-Value of hundreds of A/B tests and returns the one that have reached statistical significance. I did this to practice coding with SQLite, Pandas, and a few other libraries.
